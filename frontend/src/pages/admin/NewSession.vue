<template>
 ...
 <div class="q-gutter-y-md column" style="max-width: 100%"  ref="form" :model="form">
      ...
      <q-card class="bg-primary text-white" style="width: 300px">
        <q-card-section>
          <div class="text-h6">创建新Session成功！</div>
        </q-card-section>
...
export default {
 ...
 ,
  methods: {
      async accomplish()
      {
        var data =  {"theme":this.form.theme, "host":this.form.host, "location":this.form.location, "date": {
        ...
        this.$store.dispatch("management/newSession", dic);
        var result = 0;
         this.confirm = true;
      },
